# this is vector database setup for zilliz cloud
    ...
    try:
        ...
        if utility.has_collection(COLLECTION_NAME):
            ...
            fields = [
                ...
                FieldSchema(name="company_name", dtype=DataType.VARCHAR, max_length=500),
...
def insert_customer_embedding(company_name: str, question: str, answer: str):
    """
    Insert customer embedding into Zilliz
    
    Args:
        mongodb_id: MongoDB document ID
        company_name: Company name
        question: Question text
        answer: Answer text
        embedding: Vector embedding of the customer data
    """
    try:

        vector = model.encode(answer).tolist()
...
def search_similar_customers(query_embedding: list, top_k: int = 5):
    ...
    Returns:
        List of search results with mongodb_id, customer_name, and similarity scores
    """
    try:
        search_params = {
            "metric_type": "L2",
